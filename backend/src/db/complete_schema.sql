...
-- Run this in your PostgreSQL database (local or production)
...
-- ============================================================================
-- EMAIL LOGS TABLE (for email sending attempts and admin email dashboard)
-- ============================================================================
...
-- ============================================================================
-- Note: RLS policies are commented out by default.
-- Uncomment and customize if you need row-level security.
