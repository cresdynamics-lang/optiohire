      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-neutral-500 dark:text-neutral-400 mt-1">Guide to your HR capabilities and quick tools</p>
          </div>
        </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="p-4 bg-slate-50 dark:bg-gray-800 rounded-xl border border-slate-100 dark:border-gray-700">
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">How does the AI candidate screening work?</h4>
              ...
              <div className="p-4 bg-slate-50 dark:bg-gray-800 rounded-xl border border-slate-100 dark:border-gray-700">
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">How do I schedule an interview with a candidate?</h4>
                <p className="text-sm text-neutral-600 dark:text-neutral-300">
              ...
              <div className="p-4 bg-slate-50 dark:bg-gray-800 rounded-xl border border-slate-100 dark:border-gray-700">
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">What is the "Automated Screening Digest" email?</h4>
                <p className="text-sm text-neutral-600 dark:text-neutral-300">
        ...
        <Card className="border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-900">
          ...
          <CardContent>
            <div className="flex flex-wrap gap-4">
              ...
              <Button variant="outline" onClick={() => document.dispatchEvent(new Event('open-hr-assistant'))} className="flex items-center gap-2 dark:text-white">
