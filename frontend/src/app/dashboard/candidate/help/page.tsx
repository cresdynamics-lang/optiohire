      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-neutral-500 dark:text-neutral-400 mt-1">Guide to managing your applications and profile</p>
          </div>
        </div>

        {/* Quick Links */}
        <Card className="border-slate-200 dark:border-gray-800 bg-white dark:bg-gray-900">
          <CardHeader>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="p-4 bg-slate-50 dark:bg-gray-800 rounded-xl border border-slate-100 dark:border-gray-700">
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">How does the AI evaluate my profile?</h4>
              ...
              <div className="p-4 bg-slate-50 dark:bg-gray-800 rounded-xl border border-slate-100 dark:border-gray-700">
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">How do I join a scheduled interview?</h4>
                <p className="text-sm text-neutral-600 dark:text-neutral-300">
              ...
              <div className="p-4 bg-slate-50 dark:bg-gray-800 rounded-xl border border-slate-100 dark:border-gray-700">
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">What is the Skill Gap Roadmap?</h4>
                <p className="text-sm text-neutral-600 dark:text-neutral-300">
        ...
        {/* Important Info */}
        <Card className="bg-emerald-900/10 border-emerald-800/20 dark:bg-emerald-900/20 dark:border-emerald-800/40">
          <CardHeader>
          ...
          <CardContent className="space-y-3 text-emerald-800 dark:text-emerald-200">
            <p>
