...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${BACKEND_URL}/candidate/applications`, {
      headers: {
    ...
    console.error('Proxy GET candidate-applications error:', err)
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Proxy POST candidate-application error:', err)
