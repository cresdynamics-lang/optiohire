...
export default function AdminSupportTicketsPage() {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-slate-900 mb-1">Support & Demos</h1>
        <p className="text-slate-500">View messages, issues, and demo requests from HR users.</p>
      </div>
      ...
      <Tabs defaultValue="tickets" className="w-full">
        ...
        <TabsContent value="demos">
          {demos.length === 0 ? (
            <Card className="bg-slate-50 border-dashed border-2">
              <CardContent className="flex flex-col items-center justify-center h-48 text-slate-500">
                <Calendar className="h-8 w-8 mb-4 text-slate-400" />
                ...
                <Card key={demo.id} className="overflow-hidden">
                  <CardHeader className="bg-slate-50/50 pb-4 border-b">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex flex-col items-end gap-2">
                        <span className="text-sm text-slate-500 font-semibold text-blue-600">
